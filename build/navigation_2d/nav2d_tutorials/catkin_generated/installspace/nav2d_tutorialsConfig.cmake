...
if("FALSE" STREQUAL "TRUE")
  set(nav2d_tutorials_SOURCE_PREFIX /home/evan/share/coverage_path_ws/src/navigation_2d/nav2d_tutorials)
  set(nav2d_tutorials_DEVEL_PREFIX /home/evan/share/coverage_path_ws/devel)
  ...
  set(nav2d_tutorials_INSTALL_PREFIX /home/evan/share/coverage_path_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nav2d_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/evan/share/coverage_path_ws/install/${idir}'.  Ask the maintainer 'Sebastian Kasperski <sebastian.kasperski@dfki.de>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${nav2d_tutorials_dep}_FOUND)
      find_package(${nav2d_tutorials_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${nav2d_tutorials_dep} REQUIRED ${depend_list})
  endif()
