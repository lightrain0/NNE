...
float64 theta"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3df.pack(_x.final_pose.x, _x.final_pose.y, _x.final_pose.theta, _x.final_distance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.final_pose.x, _x.final_pose.y, _x.final_pose.theta, _x.final_distance,) = _struct_3df.unpack(str[start:end])
      return self
