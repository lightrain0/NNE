...
float64 theta"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_6df.pack(_x.robot_pose.x, _x.robot_pose.y, _x.robot_pose.theta, _x.target_pose.x, _x.target_pose.y, _x.target_pose.theta, _x.distance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.robot_pose.x, _x.robot_pose.y, _x.robot_pose.theta, _x.target_pose.x, _x.target_pose.y, _x.target_pose.theta, _x.distance,) = _struct_6df.unpack(str[start:end])
      return self
