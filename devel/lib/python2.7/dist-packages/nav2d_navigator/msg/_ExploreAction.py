...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d3I.pack(_x.action_result.result.final_pose.x, _x.action_result.result.final_pose.y, _x.action_result.result.final_pose.theta, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_6df.pack(_x.action_feedback.feedback.robot_pose.x, _x.action_feedback.feedback.robot_pose.y, _x.action_feedback.feedback.robot_pose.theta, _x.action_feedback.feedback.target_pose.x, _x.action_feedback.feedback.target_pose.y, _x.action_feedback.feedback.target_pose.theta, _x.action_feedback.feedback.distance))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_result.result.final_pose.x, _x.action_result.result.final_pose.y, _x.action_result.result.final_pose.theta, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_3d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_feedback.feedback.robot_pose.x, _x.action_feedback.feedback.robot_pose.y, _x.action_feedback.feedback.robot_pose.theta, _x.action_feedback.feedback.target_pose.x, _x.action_feedback.feedback.target_pose.y, _x.action_feedback.feedback.target_pose.theta, _x.action_feedback.feedback.distance,) = _struct_6df.unpack(str[start:end])
      return self
