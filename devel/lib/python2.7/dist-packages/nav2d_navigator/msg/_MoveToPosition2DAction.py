...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d2f3I.pack(_x.action_goal.goal.target_pose.x, _x.action_goal.goal.target_pose.y, _x.action_goal.goal.target_pose.theta, _x.action_goal.goal.target_distance, _x.action_goal.goal.target_angle, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3df3I.pack(_x.action_result.result.final_pose.x, _x.action_result.result.final_pose.y, _x.action_result.result.final_pose.theta, _x.action_result.result.final_distance, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.target_pose.x, _x.action_goal.goal.target_pose.y, _x.action_goal.goal.target_pose.theta, _x.action_goal.goal.target_distance, _x.action_goal.goal.target_angle, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_3d2f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.final_pose.x, _x.action_result.result.final_pose.y, _x.action_result.result.final_pose.theta, _x.action_result.result.final_distance, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_3df3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
