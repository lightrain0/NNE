...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2b3f3I.pack(_x.robot_id, _x.laser_type, _x.x, _x.y, _x.yaw, _x.scan.header.seq, _x.scan.header.stamp.secs, _x.scan.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.robot_id, _x.laser_type, _x.x, _x.y, _x.yaw, _x.scan.header.seq, _x.scan.header.stamp.secs, _x.scan.header.stamp.nsecs,) = _struct_2b3f3I.unpack(str[start:end])
      start = end
      end += 4
