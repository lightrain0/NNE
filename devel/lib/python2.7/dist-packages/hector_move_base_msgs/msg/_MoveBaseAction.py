...
"""autogenerated by genpy from hector_move_base_msgs/MoveBaseAction.msg. Do not edit."""
import sys
...
import hector_move_base_msgs.msg
import std_msgs.msg

class MoveBaseAction(genpy.Message):
  _md5sum = "8d353c0b5b175819f2d8ccc26d92b8f2"
  _type = "hector_move_base_msgs/MoveBaseAction"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """MoveBaseActionGoal action_goal
...
"""
  ...
  _slot_types = ['hector_move_base_msgs/MoveBaseActionGoal','hector_move_base_msgs/MoveBaseActionResult','hector_move_base_msgs/MoveBaseActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = hector_move_base_msgs.msg.MoveBaseActionGoal()
      if self.action_result is None:
        self.action_result = hector_move_base_msgs.msg.MoveBaseActionResult()
      if self.action_feedback is None:
        self.action_feedback = hector_move_base_msgs.msg.MoveBaseActionFeedback()
    else:
      self.action_goal = hector_move_base_msgs.msg.MoveBaseActionGoal()
      self.action_result = hector_move_base_msgs.msg.MoveBaseActionResult()
      self.action_feedback = hector_move_base_msgs.msg.MoveBaseActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d2f2B3I.pack(_x.action_goal.goal.target_pose.pose.position.x, _x.action_goal.goal.target_pose.pose.position.y, _x.action_goal.goal.target_pose.pose.position.z, _x.action_goal.goal.target_pose.pose.orientation.x, _x.action_goal.goal.target_pose.pose.orientation.y, _x.action_goal.goal.target_pose.pose.orientation.z, _x.action_goal.goal.target_pose.pose.orientation.w, _x.action_goal.goal.speed, _x.action_goal.goal.distance, _x.action_goal.goal.exploration, _x.action_goal.goal.reverse_allowed, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
...
_struct_7d2f2B3I = struct.Struct("<7d2f2B3I")
