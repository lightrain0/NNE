...
if("TRUE" STREQUAL "TRUE")
  set(sbpl_lattice_planner_SOURCE_PREFIX /home/evan/share/coverage_path_ws/src/sbpl_lattice_planner)
  set(sbpl_lattice_planner_DEVEL_PREFIX /home/evan/share/coverage_path_ws/devel)
  ...
  set(sbpl_lattice_planner_INSTALL_PREFIX /home/evan/share/coverage_path_ws/install)
...
if(NOT "/home/evan/share/coverage_path_ws/devel/include;/home/evan/share/coverage_path_ws/src/sbpl_lattice_planner/include;/opt/ros/indigo/include " STREQUAL " ")
  set(sbpl_lattice_planner_INCLUDE_DIRS "")
  set(_include_dirs "/home/evan/share/coverage_path_ws/devel/include;/home/evan/share/coverage_path_ws/src/sbpl_lattice_planner/include;/opt/ros/indigo/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'sbpl_lattice_planner' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Stefan Kohlbrecher <kohlbrecher@sim.tu-darmstadt.de>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'sbpl_lattice_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/evan/share/coverage_path_ws/src/sbpl_lattice_planner/${idir}'.  Ask the maintainer 'Stefan Kohlbrecher <kohlbrecher@sim.tu-darmstadt.de>' to fix it.")
    endif()
    _list_append_unique(sbpl_lattice_planner_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "sbpl_lattice_planner;/opt/ros/indigo/lib/libsbpl.so")
...
set(depends "roscpp;costmap_2d;nav_core;pluginlib;geometry_msgs;nav_msgs;message_runtime")
